...
const CoffeeDetails = () => {
  ...
  const {photo, suppiler, details, category, name, quantity, price} =
    coffeeData || {};
  ...
  return (
    <div className="p-6 relative">
      ...
      {coffeeData ? (
        <div className="md:w-10/12 mx-auto mt-5 p-6 md:px-20 bg-base-200 text-left rounded-lg flex flex-col md:flex-row gap-6  items-center py-8">
          <div className="md:w-1/2">
            <img className="w-80 md:w-120" src={photo} alt="" />
          </div>
        ...
        <Navigate to="/errorPage"></Navigate>
      )}
    </div>
  );
};
